...
export const COMMENT_GREETING = `${getInput('bot_icon')}   Vest AI`

export const COMMENT_TAG =
  '<!-- This is an auto-generated comment by Vest AI -->'

export const COMMENT_REPLY_TAG =
  '<!-- This is an auto-generated reply by Vest AI -->'

export const SUMMARIZE_TAG =
  '<!-- This is an auto-generated comment: summarize by Vest AI -->'

export const IN_PROGRESS_START_TAG =
  '<!-- This is an auto-generated comment: summarize review in progress by Vest AI -->'

export const IN_PROGRESS_END_TAG =
  '<!-- end of auto-generated comment: summarize review in progress by Vest AI -->'

export const DESCRIPTION_START_TAG =
  '<!-- This is an auto-generated comment: release notes by Vest AI -->'
export const DESCRIPTION_END_TAG =
  '<!-- end of auto-generated comment: release notes by Vest AI -->'

export const RAW_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: raw summary by Vest AI -->
<!--
`
export const RAW_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: raw summary by Vest AI -->`

export const SHORT_SUMMARY_START_TAG = `<!-- This is an auto-generated comment: short summary by Vest AI -->
<!--
`

export const SHORT_SUMMARY_END_TAG = `-->
<!-- end of auto-generated comment: short summary by Vest AI -->`
